...
class GrapherService extends MService
{
    ...
    {
        $relation = new \App\Models\RelationType();
        $result = new \StdClass;
    ...
    public function getRelationDataCCN()
    {
        ...
        // constraints
        //
        $constraintType = new \App\Models\ConstraintType();
    ...
    {
        $entity = new \App\Models\Entity($idEntity);
    ...
    {
        $construction = new \App\Models\Construction($idCxn);
        $chosen = [
    ...
    public function getFERelationsByFrame($idEntityFrame, $chosen)
    {
        ...
        $fe = new \App\Models\ViewFrameElement();
    ...
    public function getEntityConstraintRelations($idEntity, $chosen)
    {
        ...
        $relations = [];
        $viewConstraint = new \App\Models\ViewConstraint();
