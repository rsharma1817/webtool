...
class AnnotationService extends MService
{
    ...
    {
        $idLU = NULL;
        $userLevel = App\Models\Base::getCurrentUserLevel();
        if (($userLevel == 'BEGINNER') || ($userLevel == 'JUNIOR')) {
            $user = App\Models\Base::getCurrentUser();
    ...
    public function getLayers($params, $idLanguage)
    {
        ...
        $language = \App\Models\Base::languages()[$idLanguage];
        ...
        if ($annotationType == 'c') { // corpus mode
            $as = new App\Models\AnnotationSet();
        } else {
            $as = $idAnnotationSet ? new App\Models\AnnotationSet($idAnnotationSet) : new App\Models\AnnotationSet();
        }
...
//mdump($result);
    ...
    public function getLayersData($params, $idLanguage)
    {
        ...
        //mdump($rows);
        // CE-FE
        $ltCEFE = new App\Models\LayerType();
...
// last, create data
    ...
    public function validation($as, $validation, $feedback = '')
    {
        ...
        foreach ($as as $idAnnotationSet => $o) {
            $annotationSet->getById($idAnnotationSet);
            $annotationSet->setIdAnnotationStatus(App\Models\Base::getAnnotationStatus(true, $validation));
            $annotationSet->save();
    ...
    public function notifySupervisor($as)
    {
        ...
        if ($body != '') {
            ...
            $supervisor = new App\Models\User($idSupervisor);
    ...
    {
        $cxn = new App\Models\Construction();
    ...
    {
        $gl = new App\Models\GenericLabel();
