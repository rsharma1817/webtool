...
class StructureFrameService extends MService
{
    ...
    {
        $frame = new App\Models\ViewFrame();
    ...
    {
        $result = array();
        $qualia = new App\Models\Qualia($idQualia);
...
//            $field = 'wf' . $word[0];
    ...
    public function deleteFrame($idFrame)
    {
        ...
        try {
            $frameElement = new App\Models\FrameElement();
    ...
    public function addConstraintsFE($data)
    {
        try {
            ...
            if ($data->idFrame != '') {
                ...
                $cf = new App\Models\FrameElement($data->idFrameElement);
    ...
    public function addConstraintsLU($data)
    {
        try {
            ...
            if ($data->idLUQualia != '') {
                ...
                $luQualia = new App\Models\LU($data->idLUQualia);
                Base::createEntityRelation($lu->getIdEntity(), $data->relation, $luQualia->getIdEntity());
            }
            if ($data->idLUMetonymy != '') {
                $lu = new App\Models\LU($data->idLU);
                $luMetonymy = new App\Models\LU($data->idLUMetonymy);
            ...
            if ($data->idLUEquivalent != '') {
                $lu = new App\Models\LU($data->idLU);
                $luEquivalent = new App\Models\LU($data->idLUEquivalent);
