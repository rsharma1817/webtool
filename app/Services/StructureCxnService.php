...
class StructureCxnService extends MService
{
    ...
    {
        $cxn = new App\Models\ViewConstruction();
    ...
    public function deleteCxn($idCxn)
    {
        ...
        try {
            $cxnElement = new App\Models\ConstructionElement();
    ...
    {
        $sc = new App\Models\ViewSubCorpusLU();
    ...
    {
        $sc = $isCxn ? new App\Models\ViewSubCorpusCxn() : new App\Models\ViewSubCorpusLU();
    ...
    public function getLayers($params, $idLanguage)
    {
        ...
        $as = new App\Models\AnnotationSet($idAnnotationSet);
...
//            $field = 'wf' . $word[0];
    ...
    {
        $annotationSet = new App\Models\AnnotationSet();
        $annotationSet->putLayers($layers);
    }

    public function addFELayer($idAnnotationSet)
    {
        $annotationSet = new App\Models\AnnotationSet($idAnnotationSet);
    ...
    {
        $construction = new App\Models\Construction();
    ...
    {
        $cnx = new App\Models\Construction();
    ...
    {
        $ti = new App\Models\TypeInstance();
    ...
    {
        $st = new App\Models\SemanticType();
    ...
    public function addConstraintsCX($data)
    {
        try {
            ...
            if (($data->idEntityA1 != '') && ($data->idEntityA2 != '') && ($data->relation != '')) {
                ...
                $cxn = new App\Models\Construction($data->idConstruction);
            ...
            if ($data->idEntityCE != '') {
                $constraint = Base::createEntity('CN', 'con');
                $frame = new App\Models\Frame($data->idFrame);
            ...
            if ($data->idConcept != '') {
                $cxn = new App\Models\Construction($data->idConstruction);
                $concept = new App\Models\Concept($data->idConcept);
                $conceptType = new App\Models\TypeInstance($data->idConceptType);
    ...
    public function addConstraintsCE($data)
    {
        try {
            ...
            if ($data->idConstruction != '') {
                $ce = new App\Models\ConstructionElement($data->idConstructionElement);
                $cxn = new App\Models\Construction($data->idConstruction);
            ...
            if ($data->idFrameFamily != '') {
                $constraint = Base::createEntity('CN', 'con');
                $ce = new App\Models\ConstructionElement($data->idConstructionElement);
                $frame = new App\Models\Frame($data->idFrameFamily);
            ...
            if ($data->idWordform != '') {
                $constraint = Base::createEntity('CN', 'con');
                $ce = new App\Models\ConstructionElement($data->idConstructionElement);
                $wf = new App\Models\Wordform($data->idWordform);
            ...
            */
            ...
            if ($data->idConstructionMeets != '') {
                $constraint = Base::createEntity('CN', 'con');
                $ce = new App\Models\ConstructionElement($data->idConstructionElement);
                $ceMeets = new App\Models\ConstructionElement($data->idConstructionMeets);
    ...
    public function addConstraintsCN($data)
    {
        ...
        try {
            ...
            if ($data->idConstructionElement != '') {
                $constraint = Base::createEntity('CN', 'con');
                //$cn = new App\Models\ConstraintType($data->idConstraint);
                $ce = new App\Models\ConstructionElement($data->idConstructionElement);
            ...
            if ($data->idConstruction != '') {
                ...
                if ($cxn->getIdEntity() != '') {
                    ...
                    $cn2 = new App\Models\ConstraintType($data->idConstruction);
            ...
            if ($data->idLexemeCN != '') {
                $constraint = Base::createEntity('CN', 'con');
                //$cn = new App\Models\ConstraintType($data->idConstraint);
                $lexeme = new App\Models\Lexeme($data->idLexemeCN);
            ...
            if ($data->idLemmaCN != '') {
                $constraint = Base::createEntity('CN', 'con');
                //$cn = new App\Models\ConstraintType($data->idConstraint);
                $lemma = new App\Models\Lemma($data->idLemmaCN);
            ...
            if ($data->idLUCN != '') {
                $constraint = Base::createEntity('CN', 'con');
                //$cn = new App\Models\ConstraintType($data->idConstraint);
                $lu = new App\Models\LU($data->idLUCN);
