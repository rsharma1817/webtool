...
class DataService extends MService
{
    ...
    {
        $frameModel = new App\Models\Frame();
        $frames = $frameModel->listForExport($idFrames)->asQuery()->getResult();
        $feModel = new App\Models\FrameElement();
        $entry = new App\Models\Entry();
        foreach ($frames as $i => $frame) {
            $entity = new App\Models\Entity($frame['idEntity']);
            $frames[$i]['entity'] = [
            ...
            foreach ($fes as $j => $fe) {
                $frames[$i]['fes'][$j] = $fe;
                $entityFe = new App\Models\Entity($fe['idEntity']);
                ...
                $color = new App\Models\Color($fe['idColor']);
    ...
    public function importFramesFromJSON($json)
    {
        ...
        $fe = new App\Models\FrameElement();
    ...
    {
        $data = $data ?: $this->data;
        $viewCxn = new App\Models\ViewConstruction();
    ...
    {
        $cxnModel = new App\Models\Construction();
        $cxns = $cxnModel->listForExport($idCxns)->asQuery()->getResult();
        $ceModel = new App\Models\ConstructionElement();
        $entry = new App\Models\Entry();
        $cnModel = new App\Models\ViewConstraint();
        $result = [];
        foreach ($cxns as $i => $cxn) {
            $cxnModel->getById($cxn['idConstruction']);
            $entity = new App\Models\Entity($cxn['idEntity']);
            $result[$i]['data'] = $cxn;
            $result[$i]['entity'] = [
                'idEntity' => $entity->getId(),
                'alias' => $entity->getAlias(),
            ...
            foreach ($ces as $j => $ce) {
                ...
                $entityCe = new App\Models\Entity($ce['idEntity']);
    ...
    public function importCxnFromJSON($json)
    {
        ...
        $cxnModel = new App\Models\Construction();
        $ceModel = new App\Models\ConstructionElement();
        $entityModel = new App\Models\Entity();
    ...
    public function exportCorpusToXML()
    {
        ...
        foreach($documents as $idDocument) {
            $document = new \App\Models\Document($idDocument);
    ...
    public function exportDocumentToXML($corpus, $document)
    {
        ...
        //$idLanguage = \App\Models\Base::getIdLanguage($this->data->language);
...
HERE;
    ...
    public function exportDocumentToCONLL($document)
    {
        ...
        $lines = '';
        $lexemeCache = [];
        $wf = new App\Models\Wordform();//new App\Models\ViewWfLexemeLemma();
