...
- Document the codes and result discussion for GSoC First Evaluation in Week 5. ![completed](https://img.shields.io/static/v1?label=&message=completed&color=green)
- (Stretch Goal) Implement Syntax-Agnostic Frame Semantics Role Labeling ![stretch](https://img.shields.io/static/v1?label=&message=stretch&color=orange) ![completed](https://img.shields.io/static/v1?label=&message=completed&color=green) ![experiments failed](https://img.shields.io/static/v1?label=&message=experiment_failed&color=red) 
