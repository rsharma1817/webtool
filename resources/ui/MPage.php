 ...
 * A renderização pode seguir um template ou não. O template default é indicado na configuração _conf.php.
 */
class MPage extends MBase
{
    ...
    public function setTemplate()
    {
        ...
        //$this->template->setBaseUrl(Manager::getStaticURL(true));
    ...
    public function fetch($template = '')
    {
        ...
        $html = $template != '' ? $this->template->fetch($template) : $this->generate();
        return $html;
    }
