<?php
// source: /home/framenetbr/public_html/webtoolmm/public/themes/webtool/index.html

use Latte\Runtime as LR;

class Templatec6df971d8f extends Latte\Runtime\Template
{
...
<div id="appContainer" class="easyui-layout" style="width:100%;height:100%;">
    <div data-options="region:'north',title:'<?php echo $manager->getOptions('mainTitle') /* line 6 */ ?>',split:false,border:false,collapsible:false" style="height:55px;background-color:#efefef">
        <div id="menuPane" class="melement" data-manager="href:'<?php echo LR\Filters::escapeHtmlAttr($manager->getURL('main/main/menu')) /* line 7 */ ?>'"></div>
        <div id="userPane" class="melement clearfix" data-manager="href:'<?php echo LR\Filters::escapeHtmlAttr($manager->getURL('main/main/userdata')) /* line 8 */ ?>'"></div>
    </div>
