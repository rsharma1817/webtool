 ...
 * http://host.domain[:port]/(path/)(index.php)[(module/)]((controller|service|component)/)(action/)(id/)?querystring.
 * Arquivos a serem acessados diretamente devem estar na pasta public
 */
class MContext
{
    ...
    public function defineContext()
    {
        ...
        if ($first != '') {
            ...
            if ($part == 'api') {
                ...
                */
                $this->module = $part;
                $part = array_shift($pathParts) ?: 'main';
            }
    ...
    public function setupContext()
    {
        ...
        if ($app != '') {
            if ($app == 'core') {
                ...
                $this->app = $app;
                // load app conf
                //$configFile = Manager::getAbsolutePath("apps/{$this->app}/conf/_conf.php");
