...
interface IDataBase
{
    ...
    public function execute(_database\MSQL $sql, $parameters);

    public function executeBatch($sqlArray);

    public function executeCommand($command, $parameters);

    public function count(_database\MQuery $query);

    public function getNewId($sequence);

    public function prepare(_database\MSQL $sql);

    public function query(_database\MSQL $sql);

    public function executeQuery($command, $parameters, $page, $rows);

    public function getQueryCommand($command);

    public function getQuery(_database\MSQL $sql);
