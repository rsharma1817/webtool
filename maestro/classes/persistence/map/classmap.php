...
class ClassMap
{
    ...
    public function __construct($name, $databaseName)
    {
        ...
        //$this->db = PersistentManager::getConnection($databaseName);
    ...
    {
        return PersistentManager::getConnection($this->databaseName);
    }
    ...
    public function setSuperClassName($superClassName)
    {
        if (($superClassName != 'businessmodel') && ($superClassName != 'persistentobject')) {
            ...
            $this->superClassMap = PersistentManager::getClassMap($superClassName);
        }
    }
